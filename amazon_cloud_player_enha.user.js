...
var o = {
	...
	total: 0,
	pk: 'caf8ea87acced94fdea87acee154fdea', // Private key unique to each individual download of this file. Do not change this!
	amazonid: null,
	init: function () {
		...
		if (el) {
			if (unsafeWindow && unsafeWindow.amznMusic && unsafeWindow.amznMusic.customerId) {
                ...
                o.amazonid = JSON.parse(("["+temp[i].text.split('\n')[1].split('    amznMusic.appConfig = ')[1]+"]").replace(/;/g,""))[0].customerId;
								break;
							}
						}
						o.buffer.request(
